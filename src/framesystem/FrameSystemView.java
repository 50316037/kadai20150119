...
public class FrameSystemView extends Frame implements ActionListener,WindowListener {
	private TextField text1 = new TextField("", 21);
	private TextField text2 = new TextField("", 21);
	private TextField text3 = new TextField("", 21);
	private Button button1 = new Button("ë´ÇµéZ");
	
	//M/M/1óp
	private TextField m1 = new TextField("", 17);
	private TextField m2 = new TextField("", 17);
	private TextField m3 = new TextField("", 17);
